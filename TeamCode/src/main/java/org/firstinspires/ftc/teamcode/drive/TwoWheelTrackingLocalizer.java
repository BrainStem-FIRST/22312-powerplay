...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = 1.34; // X is the up and down direction
    public static double PARALLEL_Y = 10.25 / 2; // Y is the strafe direction

    public static double PERPENDICULAR_X = -5.95;
