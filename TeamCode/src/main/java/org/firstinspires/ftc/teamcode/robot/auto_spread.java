...
@Config
@Autonomous(name="Robot: Spread Auto", group="Robot")

public class auto_spread extends LinearOpMode {
    //camera
    ...
    Pose2d startingPose, preloadPose, depositLowPose, depositMidPose, depositHighPose, pickupPose, parkingPose;
    ...
    double  preloadDeltaX, preloadDeltaY,
            ...
            depositLowDeltaX, depositLowDeltaY,
            depositMidDeltaX, depositMidDeltaY,
            depositHighDeltaX, depositHighDeltaY;
...
//                        SampleMecanumDrive.getAccelerationConstraint(95))
    ...
    public void runOpMode() throws InterruptedException {
        ...
        depositLowPose = new Pose2d(XFORM_X * (54 + depositLowDeltaX), XFORM_Y * (11.5 + depositLowDeltaY), Math.toRadians(depositHeading));
        depositMidPose = new Pose2d(XFORM_X * (26 + depositMidDeltaX), XFORM_Y * (11.5 + depositMidDeltaY), Math.toRadians(depositHeading));
        depositHighPose = new Pose2d(XFORM_X * (0 + depositHighDeltaX), XFORM_Y * (11.5 + depositHighDeltaY), Math.toRadians(depositHeading));
