...
public class GrabberA {
    ...
    public final double OPEN_VALUE      = 0.62;      // 0.27
    public final double CLOSED_VALUE    = 0.87;     // 0.12
    ...
    public GrabberA(HardwareMap hwMap, Telemetry telemetry, Map stateMap) {
        ...
        grabber.setPwmRange(new PwmControl.PwmRange(1200,1675)); // previously 2055 and 2470 (1565)
        //grabberOpen();
    }
